...
@section('content')
    ...
    <div class="no-gutters">
        <form action="{{ route('products.store') }}" method="POST" id="blog-form"  enctype="multipart/form-data" >
            @csrf
        <div class="col-xl-12">
                ...
                <div class="auth-form">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-xl-6">
                                ...
                                <input type="text" class="form-control digitInput" name="price" placeholder="Price" required>
                                <span style="color: red;">@error('price'){{$message}}@enderror</span>

                            </div>
                            <div class="mb-3 col-xl-6">
                                <label class="mb-1 ms-1"><strong>Sale Price</strong></label>
                                <input type="text" class="form-control digitInput" name="sale_price" placeholder="Sale Price" required>
                                <span style="color: red;">@error('sale_price'){{$message}}@enderror</span>

                            </div>
                            <div class="mb-3 col-xl-6">
                                <label class="mb-1 ms-1"><strong>Qauantity</strong></label>
                                <input type="text" class="form-control digitInput" name="quantity" placeholder="Qauantity" required>
                            ...
                            <div class="mb-3 col-xl-6">
                                ...
                                <input type="text" class="form-control" name="english_type" placeholder="English" required>
                                <span style="color: red;">@error('type'){{$message}}@enderror</span>

                            </div>
                            <div class="mb-3 col-xl-6">
                                <label class="mb-1 ms-1"><strong>Urdu Type</strong></label>
                                <input type="text" class="form-control" name="urdu_type" placeholder="Urdu" required>
                                <span style="color: red;">@error('type'){{$message}}@enderror</span>
                            ...
                            <div class="mb-3 col-xl-6">
                                ...
                                <select  class="form-control" name="category_id" required="">
                                    ...
                                    <option value="{{$category->id}}">{{$category->english_title}}
                                    </option>
                                    @endforeach
                                </select>
                                <span style="color: red;">@error('weight'){{$message}}@enderror</span>
                            ...
                            <div class="mb-3 col-xl-6">
                                ...
                                <input type="text" class="form-control" name="urdu_description" placeholder="Urdu Description" required>
                                <span style="color: red;">@error('urdu_title'){{$message}}@enderror</span>

                            </div>
                            <div class="mb-3 col-xl-6">
                                <label class="mb-1 ms-1"><strong>Enlish Description</strong></label>
                                <input type="text" class="form-control" name="english_description" placeholder="Enlish Description" required>
                                <span style="color: red;">@error('urdu_title'){{$message}}@enderror</span>
